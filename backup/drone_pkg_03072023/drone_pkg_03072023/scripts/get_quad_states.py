...
def callback(data):
    ...
    quad_agular_vel = [data.angular_velocity.x, data.angular_velocity.y, data.angular_velocity.z]
...
def listener():
    ...
    pub=rospy.Publisher("/quad/quad_states",quad_states,queue_size=1)
