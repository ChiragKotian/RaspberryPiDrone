...
if __name__ == "__main__":
    ...
    att_pub = rospy.Publisher("/drone1/mavros/setpoint_raw/attitude", AttitudeTarget, queue_size=1)
    ...
    while(not rospy.is_shutdown() ):
        ...
        des_th = -1*((Channels[1] - 1500.0) / 500.0) * 45.0 * 3.14159265359 / 180.0
        determine_yaw() 
        des_throttle = (Channels[2] - 1000.0) / 1000.0

        rospy.loginfo(" des_ph -> " + str(des_ph) + " des_th -> " + str(des_th)+ " des_ps -> " + str(des_ps) + " des_throttle -> " + str(des_throttle))
